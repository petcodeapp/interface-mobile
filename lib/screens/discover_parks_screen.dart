          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Pet Parks Near You', style: StyleConstants.blackThinTitleTextSmall,),
              ],
            ),
          ),
        ),
        body: Center(
          child: Text('Map go here'),
        ),
        panel: Column(
          children: [
            ...
            Expanded(
              child: Padding(
                ...
                child: Padding(
                  ...
                  child: ListView(
                    children: [
                      parkLocationWidget('Pet Park Name', '123 Main Street, Main Street, CA 11111'),
      ...
      child: Row(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              Text(parkName, style: StyleConstants.lightBlackThinTitleTextSmall,),
              Text(address, style: StyleConstants.greyThinDescriptionTextSmall,),
            ],
          )
        ],
      ),
