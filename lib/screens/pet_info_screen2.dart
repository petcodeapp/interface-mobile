...
class PetInfoScreen2 extends StatefulWidget {
  final int petIndex;
  PetInfoScreen2({Key key, this.petIndex}) : super(key: key);

  @override
  _PetInfoScreen2State createState() => _PetInfoScreen2State();
}

class _PetInfoScreen2State extends State<PetInfoScreen2> {
