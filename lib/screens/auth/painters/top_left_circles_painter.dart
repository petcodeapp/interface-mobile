...
class TopLeftCirclesPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Rect darkBlueCircleRect = Rect.fromCenter(center: Offset(0.0, 0.0), width: size.width * 0.52 * 2, height: size.height * 0.27 * 2);
    Rect lightBlueCircleRect = Rect.fromCenter(center: Offset(0.0, 0.0), width: size.width * 0.6 * 2, height: size.height * 0.25 * 2);
